...
### CMS Dienste (Content-Management-System)
- [Bookstack](./services/bookstack.md)
- [WordPress](./services/wordpress.md)


### Dateiverwaltung/Datenvisualisierung
...
### Messenger/Konferenz Dienste
- [Jitsi](./services/jitsi.md)
- [Matrix](./services/matrix.md)
- [Teamspeak](./services/teamspeak.md)
