...
!!! info ""
    ...
    ```nginx
    # /etc/nginx/sites-available/homepage.example.com
    ...
    server {
        ...
        ssl_certificate /root/.acme.sh/homepage.example.com_ecc/fullchain.cer;
        ssl_certificate_key /root/.acme.sh/homepage.example.com_ecc/homepage.example.com.key;
...
services:
  homepage:
    ...
    labels:
      ...
      - "traefik.http.routers.r_homepage.rule=Host(`homepage.example.com`)"
